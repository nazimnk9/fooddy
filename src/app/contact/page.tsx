          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                >
                  ...
                  {contactInfo.map((item, index) => (
                    <motion.a
                      ...
                      className="flex items-start gap-4 p-4 rounded-lg bg-secondary hover:bg-secondary/80 transition-all duration-300 group card-hover"
                    >
              ...
              >
                ...
                <div className="rounded-xl overflow-hidden shadow-lg h-[400px] md:h-[500px] lg:h-[410px]">
                  <iframe
